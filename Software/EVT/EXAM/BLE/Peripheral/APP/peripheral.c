...
// GAP GATT Attributes
static uint8_t attDeviceName[] = "CH58x HID";
...
void Peripheral_Init()
{
    ...
    // Setup the GAP Bond Manager
    {
        ...
        uint8_t  mitm = FALSE;                              /* MITM 修改为 FALSE， 配对的时候不用输入 passkey */
    ...
    /* Setup the GAP Bond Manager */
    {
        ...
        /* 绑定过的HID设备，会在自己的白名单中写入HID Host的地址，并将HID设备的广播过滤器的策略设置为“仅处理白名单中的设备的扫描和连接请求” */
        GAPBondMgr_SetParameter(GAPBOND_AUTO_SYNC_WL, sizeof(uint8_t), &sync_wl);
    }
#endif
...
//    battery_service_add();                       // Battery Service
//    battery_callback_register(NULL);
